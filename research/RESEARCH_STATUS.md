...
Public-facing storyboard of current research work, project maturity, pending validation, review status, and near-term needs.
...
- Public CV package with standard, one-page, index-safe, and research-status outputs.
- Gaza WASH presentation object suitable for conversion into a reproducible methods note.
- McDowell GIS and stakeholder scaffolds, pending official-source validation.
...
- Early-stage repositories remain scaffold/status objects until datasets, methods, and claim boundaries are frozen.
