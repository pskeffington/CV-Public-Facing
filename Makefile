...
stem-object-contract: living-cv stem-presence-check public-manifest-check job-cv-object-check safety-surface-check citation-check paper-evaluator-check paper-review-check
